...
trade_svm_value, trade_hold_value = trading(predicted=predicted)[0], trading(predicted=predicted)[1]

plt.title("Comparison of Linear SVM and Buy-Hold strategies")
plt.plot(x_axis, trade_svm_value)
plt.plot(x_axis, trade_hold_value)

plt.legend(['Linear SVM','Buy-Hold'])
plt.xlabel("Week")
plt.ylabel("Portfolio Value ($)")

print("Trading strategy based on Linear SVM Classifier is the most profitable at the end of year2.")
plt.show()
