'''
since it's random, the best combination that I got is N=4, d=2.

predicted labels:
['red' 'green' 'green' 'red' 'green' 'red' 'green' 'green' 'red' 'green'
 'green' 'red' 'green' 'green' 'red' 'red' 'green' 'red' 'green' 'red'
 'red' 'green' 'green' 'red' 'red' 'green' 'green' 'red' 'red' 'red'
 'green' 'red' 'red' 'green' 'green' 'green' 'green' 'red' 'red' 'green'
 'green' 'red' 'green' 'green' 'green' 'red' 'green' 'red' 'green' 'green'
 'green']
...
print("For random forest(N=5, d=1), the true positive rate is", '%s%%'%TPR)
print("For random forest(N=5, d=1), the true negative rate is", '%s%%'%TNR)