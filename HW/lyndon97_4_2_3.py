...
for i in range(begin, days_fri-1):
    if label_lst[i+1] == 'green':
        ...
        if cur_label == 'red':
            ...
            cur_label = 'red'
lst_daily_value.append(myTrading_value)
print("The maximum of the account is",round(max(lst_daily_value),2),", which is in week",lst_daily_value.index(max(lst_daily_value))+1,
      ", Date:", df1['Date'][lst_daily_value.index(max(lst_daily_value))])
print("The minimum of the account is",round(min(lst_daily_value),2),", which is in week",lst_daily_value.index(min(lst_daily_value))+1,
      ", Date:", df1['Date'][lst_daily_value.index(min(lst_daily_value))])
