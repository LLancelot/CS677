...
print("We have red in total:",correct_red+red_in_green)
print("We have green in total:",correct_green+green_in_red)
print("Correctly predicted green:",correct_green,",the accuracy is %.2f" %(100*correct_green/(correct_green+green_in_red)),"%")
print("Correctly predicted red:",correct_red,",the accuracy is %.2f" %(100*correct_red/(correct_red+red_in_green)),"%")
...
matrix = confusion_matrix(y_true = np.asarray(label_lst), y_pred= predicted)
print(matrix)
