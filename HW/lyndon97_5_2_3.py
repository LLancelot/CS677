...
# dftry = data2[data2['week_id'] == 37].copy()
# print(dftry)
# print(dftry['week_id'].values[0])
#
myKNN.draw_decision_boundary(data2[data2['week_id'] == 22])
myKNN.draw_decision_boundary(data2[data2['week_id'] == 39])
